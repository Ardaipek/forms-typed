...
export type Simple = string | number | boolean | Function | null;
/**
...
/**
 * Takes a Model type and optionally a controls describtion type and returns a Typed Form Group
 * @param controls controls matching the model properties 
 * @param validatorOrOpts validator or options (like second param FormGroup constructor)
 * @param asyncValidator async validator (like third param FormGroup constructor)
 */
export function typedFormGroup<K, C extends Controls<K> = TypedControlsIn<K>>(
  controls: K extends Simple ? never : C,
