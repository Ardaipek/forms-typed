 ...
 */
interface TypedFormGroup<K, C extends Controls<K> = TypedControlsIn<K>, kt extends KT = 'control'> extends FormGroup, TypedFormControl<K> {
...
function typedFormGroup<K, C extends Controls<K> = TypedControlsIn<K>, kt extends KT = 'control'>(
  controls: K extends NonGroup ? never : C,
  validatorOrOpts?: ValidatorFn | ValidatorFn[] | AbstractControlOptions | null,
  asyncValidator?: AsyncValidatorFn | AsyncValidatorFn[] | null
): TypedFormGroup<K, C, kt> {
